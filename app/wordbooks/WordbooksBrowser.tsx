...
export default function WordbooksBrowser({ items }: Props) {
  ...
  return (
    <section className='rounded-[18px] bg-white p-4 shadow-[rgba(19,19,22,0.7)_0px_1px_5px_-4px,rgba(34,42,53,0.08)_0px_0px_0px_1px,rgba(34,42,53,0.05)_0px_4px_8px_0px] md:p-5'>
      <div className='mb-3 flex flex-wrap items-center gap-2'>
        ...
        <input
          ...
          placeholder='搜索单词书'
          className='ml-auto h-10 rounded-xl border border-slate-200 px-3 text-sm outline-none focus:border-slate-300'
        />
      </div>
        ...
        {filteredRoots.map(node => (
          <div key={node.id} className='group'>
            <Link
              ...
              className='mb-2 block w-full overflow-hidden rounded-xl border border-slate-200 transition hover:border-slate-300'>
              <div className='aspect-[3/4] w-full p-3 text-left text-white' style={coverStyle(node.title)}>
