...
} from '@/modules/media-subtitles/server/repository'
import {
  mediaSubtitlePayloadSchema,
  type MaterialPayload,
} from '@/lib/codecs/material-payload'

function formatSubtitleMeta(payload: MaterialPayload<'MEDIA_SUBTITLE'>) {
...
function buildMetadataDescription(title: string, payload: MaterialPayload<'MEDIA_SUBTITLE'>) {
...
export async function generateMetadata({
  ...
  const payload = mediaSubtitlePayloadSchema.parse(row.contentPayload)
