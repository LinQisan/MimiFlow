...
export default function CreateLevelForm() {
  ...
  if (!isOpen) {
    return (
      <button
        ...
        className='mb-4 w-full rounded-xl border border-dashed border-indigo-300 px-4 py-2.5 text-sm font-semibold text-indigo-600 transition-colors hover:bg-indigo-50 md:mb-6'>
        新增分类
      </button>
    )
  }
  ...
  return (
    <form
      ...
      className='mb-6 rounded-2xl border border-indigo-100 bg-indigo-50/50 p-4 md:p-5'>
