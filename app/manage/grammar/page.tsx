...
import GrammarCreatePanel from '@/modules/grammar/components/GrammarCreatePanel'
import GrammarEditTable from '@/modules/grammar/components/GrammarEditTable'
import type { ConstructionDraft } from '@/modules/grammar/components/GrammarConstructionsEditor'
import { getGrammarManagementData } from '@/modules/grammar/server/repository'
