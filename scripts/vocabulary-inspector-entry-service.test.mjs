...
function createHarness() {
  ...
  const stubs = {
    ...
    '../domain/sentence-pos-tags': { normalizeVocabularySentencePosTags: value => value || [] },
    './repository': { listVocabularySentenceLinks: async () => [sentenceLink()], resolveAudioDialogueClips: async () => ({}) },
