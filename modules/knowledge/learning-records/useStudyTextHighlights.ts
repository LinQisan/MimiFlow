...
import { resolveJlptHighlightSlot } from '@/modules/reading/domain/wordbook-highlight-groups'
import { resolvePrimaryVocabularyJlpt } from '@/modules/knowledge/vocabulary/domain/jlpt'
...
const normalizeVocabTokenSurface = normalizeVocabularyWord
      ...
      ;[...wordbookGroups]
        ...
        .forEach(group => {
          ...
          words.forEach(word => {
            ...
            const primaryJlpt = resolvePrimaryVocabularyJlpt(jlptLevels)
            candidates.push({
              word,
              sourceId: group.id,
