...
import { useQuestionListEditorState } from '@/modules/questions/hooks/useQuestionListEditorState'
...
import { useLessonQuestionPageState } from '@/modules/questions/hooks/useQuestionEditorPageState'
import QuestionTypeBadge from '@/modules/questions/components/QuestionTypeBadge'
import {
...
import ListeningOptionQuickInput from '@/modules/questions/components/ListeningOptionQuickInput'
          ...
          {bulkParsed.length > 0 && (
            <div className='space-y-2 max-h-60 overflow-y-auto'>
              {bulkParsed.map((draft, i) => {
                const tc = getQuestionEditorTypeConfig(draft.questionType)
                return (
        ...
        {questions.length === 0 ? (
          ...
          <SortableList
            ...
            {questions.map((q, index) => {
              ...
              const tConfig = getQuestionEditorTypeConfig(q.questionType)
