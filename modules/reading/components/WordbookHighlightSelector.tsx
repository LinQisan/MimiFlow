...
const LEVEL_STRONG_CLASSES: Record<VocabularyJlptLevel, string> = {
...
export default function WordbookHighlightSelector({
  ...
  hiddenWordbookIds,
  onVisibilityChange,
  hiddenJlptLevels = new Set<VocabularyJlptLevel>(),
  ...
  hiddenJlptLevels?: Set<VocabularyJlptLevel>
  onJlptVisibilityChange?: (levels: VocabularyJlptLevel[], visible: boolean) => void
  ...
  ) as Record<VocabularyJlptLevel, number>
