...
const PerformanceStatsDialog = dynamic(
  () => import('@/modules/practice/components/PerformanceStatsDialog'),
)
const PracticeVocabularyAnalyticsDialog = dynamic(
  () => import('@/modules/practice/components/PracticeVocabularyAnalyticsDialog'),
)
...
export function VocabularyAnalyticsLauncher({
  ...
  const prefetchAnalytics = useCallback(() => {
    ...
    void import('@/modules/practice/components/PracticeVocabularyAnalyticsDialog')
